...
<body onload="noBack();" onpageshow="if (event.persisted) noBack();" onunload="">
       	<form:form method="post" action="re-login" modelAttribute="student">  
			<div class="container">
	        	<form:hidden path="id"  />
				<label for="mmail"><b>Email</b></label>
				...
				<p>By Logging in here you can take your exam</p>
			...
			<div class="container" style="background-color:#f1f1f1">
	    			<button type="button" class="cancelbtn" onclick="logout()">Cancel</button>
			</div>
       	</form:form> 
